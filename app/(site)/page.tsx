    ...
    <>
      ...
      <section className="overflow-x-clip">
        ...
        <div className="flex flex-col gap-3">
          <p className="body-text">An independent research practice working on the gap between what language and models can express and what happens because of it.</p>
          <p className="body-text">
            Current focus: structured representations as an alternative to scaling. Our first proof is{' '}
